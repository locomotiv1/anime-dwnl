...
### List your Anime
View your "Currently Watching" list, comparing your watched episodes against the total released episodes.
```bash
anime list
```

### Download Missing Episodes
Download all missing episodes for **every** anime on your currently watching list. *(Warning: This might take a while if you have a lot of missing episodes!)*
```bash
anime download
```
